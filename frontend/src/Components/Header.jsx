  ...
  return (
    <header className="h-16 shadow-md bg-white">
      <div className="h-full container mx-auto flex items-center px-4 justify-between">
        <div className="">
         <Link to={"/"}> <img src={Logo} alt="Logo" width={90} h={50} /></Link>
        </div>
        ...
        <div className="flex items-center gap-7">
          ...
          <div className="text-2xl relative">
            ...
            <div className="bg-red-600 text-white w-5 h-5 rounded-full p-1 flex items-center absolute -top-2 -right-3">
              <p className="text-sm p-0.5">0</p>
            </div>
          </div>
          <div>
